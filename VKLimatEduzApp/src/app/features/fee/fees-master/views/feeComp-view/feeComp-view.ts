...
@Component({ selector: 'app-feeComp-view', imports: [FormsModule], templateUrl: './feeComp-view.html', styleUrls: ['../fee-master-view.scss'], changeDetection: ChangeDetectionStrategy.OnPush })
export class FeeCompView extends FeeMasterView {
  readonly title = 'FeeComp View';
  readonly fields = [
    { key: 'code', label: 'Code' }, { key: 'name', label: 'Fee Component Name' }, { key: 'description', label: 'Category' },
